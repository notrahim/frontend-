...
computed: {
  ...
  postData() {
    const data = {
      LocGerance_Debut: this.computedDate,
      LocGerance_Fin: this.computedDate_1,
      LocGerance_TaciteBool : this.switch2,
      LocGerance_LouNom : this.nom,
      LocGerance_LouPrenom : this.prenom,
      LocGerance_LouRue : this.LoueurRue,
      LocGerance_LouZip : this.LoueurZip,
      LocGerance_LouVille : this.LoueurVille,
      
      LocGerPrecedentSiren : this.PrecSiren_Loc,
      LocGerPrecedentName : this.PrecName_Loc,
      LocGerPrecedentFirstname : this.PrecFirstame_Loc
    };
    return data;
  },
},
